  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: const Color.fromARGB(255, 218, 232, 205),
        actions: [
      ...
      body: Container(
        decoration: const BoxDecoration(
          gradient: LinearGradient(
            colors: [
              Color.fromARGB(255, 193, 212, 182),
              Color.fromARGB(255, 239, 245, 217),
            ],
          ...
          child: Column(
            ...
            children: [
              ...
              _SectionCard(
                icon: Icons.school,
                title: 'Pendidikan',
                content: Text('Universitas Pasundan — Semester 6\nIPK: 3.99'),
              ),
              _SectionCard(
                icon: Icons.favorite,
                title: 'Hobi & Minat',
                content: Text('Coding • Membaca • Olahraga'),
              ),
              _SectionCard(
                icon: Icons.email,
                title: 'Kontak',
                content: Text('chalida.rahma@email.com\n+62 888-888-888'),
              ),
              _SectionCard(
                icon: Icons.stars,
                title: 'Skills',
      ...
      floatingActionButton: FloatingActionButton(
        backgroundColor: Color.fromARGB(255, 143, 170, 114),
        onPressed: () {
      ...
      //memakai navigation bar lebih modern daripada bottomnavigationbar
